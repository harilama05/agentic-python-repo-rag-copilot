...
This module clones a public GitHub repository into the local runtime data
directory, traverses the cloned tree, and returns only files accepted by the
...
RUNTIME_GITHUB_DIR = settings.repos_dir / "github"
...
def ingest_github_repo(
    ...
    """
    Clone a GitHub repository and prepare its supported files for indexing.
