...
# Legacy hybrid retrieval weights
# These are kept for backward compatibility and debugging. The current retriever
# uses RRF as the main ranking strategy.
VECTOR_WEIGHT = 0.40
BM25_WEIGHT = 0.30
SYMBOL_WEIGHT = 0.20
KEYWORD_WEIGHT = 0.10
